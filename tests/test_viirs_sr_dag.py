...
from dags.viirs_sr_dag_day_na import CFG, convert_hdf_to_geotiff, download_files, upload_in_parallel
...
dir_data = Path('data/VNP09GA')
dir_tif = Path('data/VNP09GATIF')
...
asset_id = 'projects/ee-eo4wildfire/assets/VIIRS_SR_'+id+'/'
...
def test_gee_upload():
    upload_in_parallel(id, start_date, asset_id, filepath='data/VNP09GATIF')
